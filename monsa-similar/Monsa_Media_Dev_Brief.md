...
* **Framer** or **Webflow** preferred. Both support the Lovable / 404media aesthetic and let Monika edit content without code. Framer for speed, Webflow for CMS flexibility.
...
* Case study pages built on CMS so Monika can add new ones without touching code.
...
* **Who actually runs my account?** Strategy is owned by Monika, the founder, on every engagement. Senior technical specialists with 5+ years of experience are pulled in for the more technical execution tasks. You will never be handed off to a junior account manager.
...
Most agencies treat YouTube as a checkbox under “Google Ads.” Monika spent 8 years at Google, most recently as a Regional YouTube product lead. That means video on Monsa accounts isn’t an afterthought, it’s run by someone who actually shaped how the platform works.
...
CTA: \[Talk to Monika about YouTube →\]
